    ...
    <section class="section">
        ...
        <div class="section-body">
            <div class="invoice" id="invoice-content">
                ...
                <br>
                <h5 class="" style="text-align: center;font-size: 20px"> <u>MANDERA YOUTH SUPPORT
                        PROGRAM</u></h5>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <address>
                                        ...
                                        <b>{{ strtoupper($Registration->idno) }}</b><br>

                                        <label for="" style=" width: 100px;font-size: 10px;">PHONE
                                            NUMBER</label><b>{{ strtoupper($Registration->mobile) }}</b>
                                        <br>
                                        <label for="" style=" width: 100px;font-size: 10px;">EMAIL ADDRESS:</label>
                                        <b>{{ strtoupper($Registration->User->email) }}</b><br>
                                        ...
                                        <b>{{ strtoupper($Registration->birth_date) }}</b><br>


                                        @if ($Registration->passport === 'yes')
                                        <label for="" style=" width: 100px;font-size: 10px;">PASSPORT
                                            NO:</label>
                                        <b><i>{{ strtoupper($Registration->passport_no) }}</b>
                                        <br>

                                        <label for="" style=" width: 100px;font-size: 10px;">EXPIRY
                                            DATE:</label>
                                        <b><i>{{ strtoupper($Registration->passport_date) }}</b><br>
                                        @else
                                        <!-- Display something else, like 'N/A' if the passport is not 'yes' -->

                                        @endif
                                        <label for="" style=" width: 100px;font-size: 10px;">PARENT NAME:</label>
                                        <b>{{ strtoupper($Registration->parent_name) }}<br>
                                            <label for="" style=" width: 100px;font-size: 10px;">PARENT
                                                NUMBER:</label>
                                            <b>{{ strtoupper($Registration->parent_no) }}<br>
                                    </address>
                                </div>

                                <h2 style="float: right;">
                                    <img src="{{asset('uploads/image_files/'.$Registration->id_copy)}}" width="100%"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover table-md">
                                <tr>
                                    ...
                                    <th class="text-center">Skills Training</th>


                                </tr>

                                <tr>
                                    <td class="text-center">{{$Registration->index+1}}</td>
                                    <td class="text-center">
                                        <img src="{{asset('uploads/image_files/'.$Registration->image)}}" width="50px"
                                            height="50px" alt="image">
                                    </td>
                                    <td class="text-center">{{$Registration->education}}</td>
                                    <td class="text-center">{{$Registration->grade}}</td>
                                    <td class="text-center">{{$Registration->qualification}}</td>
                                    <td class="text-center">{{$Registration->skills}}</td>
                        ...
                        <div class="row mt-4">
                            <div class="col-lg-8">
                                ...
                                <b>{{ strtoupper($Registration->employer) }}</b><br>

                                <label for="" style=" width: 120px;font-size: 10px;">YERAS OF
                                    EXPERIENCE:</label>
                                <b>{{ strtoupper($Registration->exp_year) }} YEARS</b><br>
                                <label for="" style=" width: 100px;font-size: 10px;">POSITION HELD:</label>
                                <b>{{ strtoupper($Registration->position) }}</b><br>
